...
//   action: { type: string; payload: { id: string; newFavouriteItem?: FavouriteProduct } }
// ): FavouriteProduct[] => {
//   let newItem = [...currentFavouriteValue];

//   if (action.type === "Favourite_ITEM" && action.payload.newFavouriteItem) {
//     newItem = [...currentFavouriteValue, action.payload.newFavouriteItem];
//   } else if (action.type === 'DELETE_FAVOURITE_ITEM' && action.payload.id) {
...
// const orderPlaced = (currentPlacedOrder: { totalPrice: number; totalQuantity: number[]; totalName: string[]; singleProductPrice: number[] }[],

//   action: { type: string; payload: { placedItem: { totalPrice: number; totalQuantity: number[]; totalName: string[]; singleProductPrice: number[] } } }
// ) => {
//   let newItem;
...
//   placedOrder: { totalPrice: number; totalQuantity: number[]; totalName: string[]; singleProductPrice: number[] }[];
// }
